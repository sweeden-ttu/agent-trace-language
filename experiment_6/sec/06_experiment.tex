...
Table~\ref{tab:exp6-scenarios} summarizes six verification scenarios.

\begin{table}[htbp]
\centering
\caption{Verification results for six NeuroGolf MAS scenarios.}
...
\midrule
  ...
  Correct Advanced ML Pipeline             & SUBMITTED            & \checkmark \\
...
\midrule
  01_trace_framework.ipynb                 & 10/11 & 91% \\
  02_onnx_builders.ipynb                   &  2/11 & 18% \\
  03_optimization_passes.ipynb             &  3/11 & 27% \\
  04_verified_pipeline.ipynb               &  6/11 & 55% \\
\bottomrule
\end{tabular}
\end{table}
