...
\midrule
  Correct Pipeline (13 tasks)              & Q_SUBMITTED          & \checkmark \\
  Build w/o Analysis                       & Q_ERROR              & \ding{55} \\
  Reject Unsolvable Task                   & Q_REJECTED           & \ding{55} \\
  Skip ARC-GEN Verification                & Q_SUBMITTED          & \checkmark \\
  Blend Before Full Verify                 & Q_ERROR              & \ding{55} \\
\bottomrule
\end{tabular}
\end{table}
...
We scanned the top-4 Kaggle notebooks for 21 methodology keywords.
...
\midrule
  6154-71-onnx-rewrites-hand-built-solvers &  6/21 & 29% \\
  all-task-description-analysis.ipynb      &  2/21 & 10% \\
  neurogolf-4250.ipynb                     &  1/21 & 5% \\
  neurogolf-new-blending.ipynb             &  3/21 & 14% \\
\bottomrule
\end{tabular}
\end{table}
