...
if __name__ == "__main__":
    ...
    write_notebook(n1, "01_trace_framework.ipynb")
    write_notebook(n2, "02_onnx_builders.ipynb")
    write_notebook(n3, "03_optimization_passes.ipynb")
    write_notebook(n4, "04_verified_pipeline.ipynb")
